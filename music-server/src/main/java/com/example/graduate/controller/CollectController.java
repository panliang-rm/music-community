...
import com.example.graduate.service.impl.CollectServiceImpl;
...
public class CollectController {
    ...
    public Object collectionOfUser(HttpServletRequest req) {
        ...
        return new SuccessMessage<>("取消收藏", collectService.collectionOfUser(Integer.parseInt(userId))).getMessage();
    }
}
